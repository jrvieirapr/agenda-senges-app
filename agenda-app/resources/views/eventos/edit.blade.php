...
@section('content')
    ...
    <form action="/eventos/{{$evento->id}}" method="POST">
        ...
        <div class="form-group">
            ...
            value="{{ old('descricao', $evento->descricao)}}"
        ...
        <div class="form-group">
            ...
            value="{{ old('inicio', $evento->inicio)}}"
        ...
        <div class="form-group">
            ...
            value="{{ old('contato', $evento->contato)}}"
        ...
        <div class="form-group">
            ...
            {{ old('realizado', $evento->realizado) ? 'checked' : ''}}
        ...
        <button type="submit" class="btn btn-primary" style="margin-top:5px;">Atualizar</button>        
    </form>
@endsection
